#---
# model_gam_health_station_zcta.R
#
# This Rscript:
# * fit GAM for each ZCTA in Richmond MSA using station data
...
# data #-----------
data <- readRDS(here("data/process/data_health_station_zcta.rds"))
...
# save fitted model
saveRDS(ls_model, here("data/RDSmodel/gam_health_station_zcta.rds"))
