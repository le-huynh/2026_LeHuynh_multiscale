#---
# model_mixmeta_era5_county_excluding_charles_city.R
#
# This Rscript:
# * fit meta-regression model from county-specific models, excluding Charles City County
...
#
# Produces...
# data/RDSmodel/mixmeta_era5_county_excluding_charles_city.rds
...
# data #----------------------------
mod_county <- readRDS(here("data/RDSmodel/gam_health_era5_county.rds")) %>% 
...
saveRDS(model0, here("data/RDSmodel/mixmeta_era5_county_excluding_charles_city.rds"))
...
saveRDS(pgam, here("data/RDSmodel/pgam_meta_era5_county_excluding_charles_city.rds"))
