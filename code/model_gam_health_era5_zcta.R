#---
# model_gam_health_era5_zcta.R
#
# This Rscript:
# * fit GAM for each ZCTA in Richmond MSA using ERA5 data
...
# data #-----------
data <- readRDS(here("data/process/data_health_era5_zcta.rds"))
...
# save fitted model
saveRDS(ls_model, here("data/RDSmodel/gam_health_era5_zcta.rds"))
