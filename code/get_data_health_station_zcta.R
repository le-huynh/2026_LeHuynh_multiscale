#---
# get_data_health_station_zcta.R
#
# This Rscript:
# * combine EDvisit counts (per ZCTA) and station data (hourly, wider form)
...
ls_health_era5 <- readRDS(here("data/process/data_health_era5_zcta.rds"))
...
# combine station data and EDvisit for each ZCTA
...
# save as .rds
saveRDS(ls_final,
        here("data/process/data_health_station_zcta.rds"))
