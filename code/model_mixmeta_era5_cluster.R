...
# data #----------------------------
mod_cluster <- readRDS(here("data/RDSmodel/gam_health_era5_cluster.rds"))
...
saveRDS(model0, here("data/RDSmodel/mixmeta_era5_cluster.rds"))
...
saveRDS(pgam, here("data/RDSmodel/pgam_meta_era5_cluster.rds"))
