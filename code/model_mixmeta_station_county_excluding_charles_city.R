#---
# model_mixmeta_station_county_excluding_charles_city.R
#
# This Rscript:
...
#
# Produces...
# data/RDSmodel/mixmeta_station_county_excluding_charles_city.rds
...
saveRDS(model0, here("data/RDSmodel/mixmeta_station_county_excluding_charles_city.rds"))
...
saveRDS(pgam, here("data/RDSmodel/pgam_meta_station_county_excluding_charles_city.rds"))
