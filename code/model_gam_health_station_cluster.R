#---
# model_gam_health_station_cluster.R
#
# This Rscript:
# * fit GAM for each (SVI-based) cluster in Richmond MSA using station data
...
# data #-----------
data <- readRDS(here("data/process/data_health_station_cluster.rds"))
...
# save fitted model
saveRDS(ls_model, here("data/RDSmodel/gam_health_station_cluster.rds"))
