#---
# model_mixmeta_station_zcta_mean5.R
#
# This Rscript:
...
saveRDS(mod_zcta_mean5, here("data/RDSmodel/gam_health_station_zcta_mean5.rds"))
...
saveRDS(model0_mean5, here("data/RDSmodel/mixmeta_station_zcta_mean5.rds"))
...
saveRDS(pgam_mean5, here("data/RDSmodel/pgam_meta_station_zcta_mean5.rds"))
