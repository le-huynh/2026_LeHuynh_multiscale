#---
# model_gam_health_era5_cluster.R
#
# This Rscript:
# * fit GAM for each (SVI-based) cluster in Richmond MSA using ERA5 data
...
# data #-----------
data <- readRDS(here("data/process/data_health_era5_cluster.rds"))
...
# save fitted model
saveRDS(ls_model, here("data/RDSmodel/gam_health_era5_cluster.rds"))
