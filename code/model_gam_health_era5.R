#---
# model_gam_health_era5.R
#
# This Rscript:
# * fit GAM for full Richmond MSA using ERA5 data
...
# data/RDSmodel/pgam_health_era5.rds
#---
...
# data #-----------
(data <- rio::import(here("data/process/data_health_era5_ric_msa.csv")) %>% 
         tibble())
...
# save fitted model
saveRDS(mod, here("data/RDSmodel/gam_health_era5.rds"))
...
# save prediction
saveRDS(pgam, here("data/RDSmodel/pgam_health_era5.rds"))
