#---
# get_data_health_station_county.R
#
# This Rscript:
# * combine EDvisit counts (per county) and station data (hourly, wider form)
...
ls_health_era5 <- readRDS(here("data/process/data_health_era5_county.rds"))
...
# combine station data and EDvisit for each county
...
# save as .rds
saveRDS(ls_final,
        here("data/process/data_health_station_county.rds"))
